...
$(function() {
	/* HTML DOM Tree 구조에 따라 <ul>, <li>, <a> 엘리먼트가 클릭되면 실행될 수 있는 함수 정의 */
	// page1 //
		...
		<ul data-role="listview" data-inset="true" data-theme="e">
			...
			<li>
				<a href="#page2" data-rel="dialog" data-transition="pop">
					<!-- 이미지: 소스, 제목, 설명 -->
					<img src="./image/Colosseum.jpg" width=100% height=100%>
					<h3>콜로세움</h3>
					<p>이탈리아 로마</p>
				</a>
			</li>
			...
			<li>
				<a href="#page2" data-rel="dialog" data-transition="pop">
					<!-- 이미지: 소스, 제목, 설명 -->
					<img src="./image/The_Eiffel_Tower.jpg" width=100% height=100%>
					<h3>에펠탑</h3>
					<p>프랑스 파리</p>
				</a>
			</li>
			...
			<li>
				<a href="#page2" data-rel="dialog" data-transition="pop">
					<!-- 이미지: 소스, 제목, 설명 -->
					<img src="./image/Vinus_Statue.jpg" width=100% height=100%>
					<h3>비너스상</h3>
					<p>프랑스 루브르미술관</p>
				</a>
			</li>
